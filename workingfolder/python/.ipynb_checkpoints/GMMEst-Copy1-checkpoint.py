...
# + {"code_folding": [3, 21, 25, 36, 48, 97, 157, 182, 201, 202]}
...
class NoisyInformation:
    ...
    def Forecaster(self):
        ...
        for t in range(n_history-1):
            Pkalman[t+1] = rho**2*nowvar_to_burn[t]*H.T*np.linalg.inv(H*rho**2*nowvar_to_burn[t]*H.T+sigma_v)
            nowcast_to_burn[t+1] = rho*(1-Pkalman[t+1]*H)*nowcast_to_burn[t]+ Pkalman[t+1,0]*infoset[0,t+1]
